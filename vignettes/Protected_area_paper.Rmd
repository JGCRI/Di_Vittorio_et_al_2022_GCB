...
if (tables_created){
  print("Tables all read in! Figures will be generated below")
}else{
...
### Land allocation shown here globally. For country level results, check the outputs folder in the root directory.
...
### Crop production shown here globally. For country level results, check the outputs folder in the root directory.
...
### Only Wheat prices shown here. For other commodity prices check outputs folder in root directory.
...
### Scatterplot shown here for Crops. For other land types check the output folder in the root directory.
```{r,fig.width=12, fig.height=8,echo=FALSE,message=FALSE, warning=FALSE}
